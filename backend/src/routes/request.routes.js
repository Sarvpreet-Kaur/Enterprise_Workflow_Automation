...
requestRouter.get( "/pending", authMiddleware, roleMiddleware(ROLES.MANAGER, ROLES.ADMIN), getPendingRequests);
...
requestRouter.patch( "/:id/approve", authMiddleware, roleMiddleware(ROLES.MANAGER, ROLES.ADMIN), approveRequest);
requestRouter.patch( "/:id/reject", authMiddleware, roleMiddleware(ROLES.MANAGER, ROLES.ADMIN), rejectRequest);
